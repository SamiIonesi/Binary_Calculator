...
REM
REM Generated by Vivado on Mon Jan 01 15:03:40 +0200 2024
...
echo "xvlog --incr --relax -L uvm -prj tb_mux_8b_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_mux_8b_vlog.prj -log xvlog.log
