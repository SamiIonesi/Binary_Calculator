...
REM
REM Generated by Vivado on Thu Jan 25 11:56:06 +0200 2024
...
echo "xvlog --incr --relax -L uvm -prj tb_DecInputKey_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_DecInputKey_vlog.prj -log xvlog.log
