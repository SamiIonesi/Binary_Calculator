...
REM
REM Generated by Vivado on Mon Jan 01 15:12:38 +0200 2024
...
echo "xvlog --incr --relax -L uvm -prj tb_concatenator_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_concatenator_vlog.prj -log xvlog.log
